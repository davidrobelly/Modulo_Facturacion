...
import controles.Control_Ventana_Detalle_Cotizacion;

public class Ventana_Detalle_Cotizacion extends JFrame{
	
	Control_Ventana_Detalle_Cotizacion control;
	
	public JPanel PanelCentral, PanelBotones;
	public JLabel lblcotizacion, lblproducto, lblvalor, lblcantidad;
	public JTextField txtcotizacion, txtproducto, txtvalor, txtcantidad;
	public JButton btnregistrar, btnlimpiar, btnbuscar;
	
	
	public Ventana_Detalle_Cotizacion () {
		
		initcomponents();
		ventana();
		control = new Control_Ventana_Detalle_Cotizacion(this);
		
		PanelCentral.setLayout(new GridLayout(4,2));
		PanelBotones.setLayout(new GridLayout(0,3));
		
		PanelCentral.add(lblcotizacion);
		PanelCentral.add(txtcotizacion);
	...
	private void ventana() {
		...
		this.pack();
		this.setTitle("Detalles de Cotización");
	...
	private void initcomponents() {
		...
		lblcotizacion = new JLabel ("cód. cotizacion: ");
