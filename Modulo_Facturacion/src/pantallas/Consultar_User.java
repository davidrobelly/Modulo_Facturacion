...
import controles.Control_Consulta_User;

public class Consultar_User extends JFrame{
	...
	Control_Consulta_User control;
	
	
	public Consultar_User() {
		
		initcomponents();
		ventana();
		
		control = new Control_Consulta_User(this);
