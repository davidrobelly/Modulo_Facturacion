...
import controles.Control_Consulta_Modificar_Empleados;

public class Consulta_Modificar_Empleados extends JFrame{
	...
	Control_Consulta_Modificar_Empleados control;
	
	
	public Consulta_Modificar_Empleados() {
		
		initcomponents();
		ventana();
		
		control = new Control_Consulta_Modificar_Empleados(this);
