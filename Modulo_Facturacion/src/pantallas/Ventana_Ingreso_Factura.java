...
public class Ventana_Ingreso_Factura extends JFrame {
	...
	public JLabel lblcliente, lblvendedor, lblfecha, lblvigencia, lblestado, 
			lblcantidad, lblsubtotal, lbliva, lbltotal, lblcodigo, lbllocal, lblpago;
	public JTextField txtcliente, txtvendedor, txtfecha, txtvigencia, 
			txtcantidad, txtsubtotal, txtiva, txttotal, txtcodigo, txtlocal;
	public JTable tabledetalle;
	public JComboBox cmbestado, cmbpago;
	...
	public Ventana_Ingreso_Factura () {
		...
		PanelCentral.setLayout(new GridLayout(6,4));
	...
	private void initcomponents() {
		...
		cmbpago.addItem("Crédito");
		cmbpago.addItem("Cheque");
		...
		Border bordejpanel = new TitledBorder(new EtchedBorder(), "Detalle de la Factura");
