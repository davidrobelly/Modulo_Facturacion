...
public class Tabla_Producto_Consulta_MarcaModeloCod extends AbstractTableModel{
	
	private final String[] titulo = {"Codigo", "Categoria", "Nombre", "Marca","Modelo", "Valor", "Minimo", "Maximo"};
	
	ArrayList<Producto> listaProductos = new ArrayList<>();
	
	public Tabla_Producto_Consulta_MarcaModeloCod() {
		super();
	}

	public Tabla_Producto_Consulta_MarcaModeloCod(ArrayList<Producto> lista) {
		super();
