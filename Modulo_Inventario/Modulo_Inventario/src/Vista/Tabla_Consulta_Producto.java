...
@SuppressWarnings("serial")
	...
	public class Tabla_Consulta_Producto extends AbstractTableModel{

		private final String[] titulo= {"Nombre","Marca","Modelo","Valor","Minimo","Maximo"};
		ArrayList<Producto> listaProductos = new ArrayList<>();
		
		public Tabla_Consulta_Producto() {
			super();
		}

		public Tabla_Consulta_Producto(ArrayList<Producto> lista) {
			super();
