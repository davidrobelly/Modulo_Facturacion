...
public class Pantalla_Reporte_MinMax extends JFrame{
	...
	public Pantalla_Reporte_MinMax (){
		...
		pnl_vistaReporte.setBorder(new TitledBorder("Maximos y Minimos de Productos"));
		...
		try {
			...
			JasperExportManager.exportReportToPdfFile(imprimirContarProducto,"Minimo y Maximo de Productos.pdf");
		conexion.cerrar();	
