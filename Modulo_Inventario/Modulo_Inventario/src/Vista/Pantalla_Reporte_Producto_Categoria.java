...
public class Pantalla_Reporte_Producto_Categoria extends JFrame{
	
	public ImageIcon ico_aplicacion;
	Conexion conexion = new Conexion();
	InputStream rutaJasperProductoCategoria;
	JasperReport reporteProductoCategoria;
	JasperPrint imprimirProductoCategoria;
	JRViewer vistaReporteProductoCategoria;
	public JPanel pnl_vistaReporte;
	
	public Pantalla_Reporte_Producto_Categoria (){
		...
		pnl_vistaReporte.setBorder(new TitledBorder("Productos por Categoria"));
		...
		try {
			...
			vistaReporteProductoCategoria = new JRViewer(imprimirProductoCategoria);       
			pnl_vistaReporte.add(vistaReporteProductoCategoria);
			vistaReporteProductoCategoria.setVisible(true);
			pnl_vistaReporte.repaint();
			pnl_vistaReporte.revalidate();
			JasperExportManager.exportReportToPdfFile(imprimirProductoCategoria,"Producto por Categoria.pdf");
		conexion.cerrar();	
